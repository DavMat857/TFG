...
archivos_alg = ["--- Archivos ---"]+archivos+["--- Algoritmos ---"]+list_fun+["--- Frecuencias ---"]+frecuencias
...
def obtener_elemento_seleccionado():
    ...
    if seleccion:
        ...
        archivo = elementos_seleccionados[0]
        algoritmo = elementos_seleccionados[1]
        frecuencia = elementos_seleccionados[2]
        datos = eval(frecuencia)(archivo,'G10')
        
        if algoritmo == "alg_fil":
            seleccion = elementos_seleccionados[-1]
        resultado = eval(algoritmo)(datos,10,3)
