...
archivos_alg =["--- Selección ---"]+Seleccion+["--- Archivos ---"]+archivos+["--- Algoritmos ---"]+Algoritmos+["--- Frecuencias ---"]+Frecuencias+["--- Paso ---"]+Pasos+["--- Múltiplo ---"]+Multiplos+["--- Tiempo ---"]+Tiempos
...
def obtener_elemento_seleccionado():
    ...
    if True:
        ...
        if archivo and algoritmo and frecuencia and paso and tiempo:
            datos = eval(frecuencia)(archivo,'G10')
        ...
        elif seleccion and multiplo and archivo and algoritmo and frecuencia and paso and tiempo:
            datos = eval(frecuencia)(archivo,'G10')
